...
import { Droplets, Plus, Landmark, AlertTriangle, ArrowRight, Wallet, History, ArrowUpRight, ArrowDownRight, Scale, Info, ArrowRightCircle, ShieldAlert } from "lucide-react";
...
export default function BankHub() {
    ...
    useEffect(() => {
        ...
        setTotalLiquid(BankStore.getTotalLiquidAssets());
    }, []);

    const flow = BankStore.getCashFlowMetrics();
    ...
    if (metrics) {
        ...
        const dormantUpdates = accounts.filter(a => new Date(a.latestBalanceAsOf) < new Date(Date.now() - 60 * 86400000));
                                                ...
                                                <div className="flex items-center gap-3">
                                                    ...
                                                    <div>
                                                        ...
                                                        <p className="text-[11px] text-white/40 mt-0.5 uppercase tracking-wider flex items-center gap-2">
                                                            {acc.accountType} • {BankStore.maskAccountNumber(acc.accountLast4)}
