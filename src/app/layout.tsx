...
export default function RootLayout({
  ...
  return (
    <html lang="en" className={`${inter.variable} ${cinzel.variable}`} suppressHydrationWarning>
      ...
      <body className="bg-[var(--color-rajya-bg)] text-[var(--color-rajya-text)] font-sans antialiased min-h-screen selection:bg-[var(--color-rajya-accent)] selection:text-black">
