...
export default function DocDetail() {
    ...
    const handleAddMobile = () => {
        ...
        if (!result.valid) {
            setContactError(result.message || "Enter a valid mobile number.");
            return;
        }
        ...
        try {
            ...
            setContactError(e instanceof Error ? e.message : "Could not add mobile contact.");
        }
    };
    ...
    const handleAddEmail = () => {
        ...
        if (!result.valid) {
            setContactError(result.message || "Enter a valid email.");
            return;
        }
        ...
        try {
            ...
            setContactError(e instanceof Error ? e.message : "Could not add email contact.");
        }
    };
            ...
            <div className="relative z-10 flex flex-col min-h-screen">
                ...
                <div className="flex-1 space-y-4 overflow-y-auto">
                    ...
                    <div className="space-y-2">
                        ...
                        {editing && (
                            <div className="flex gap-2">
                                <input type="tel" placeholder="Add different mobile" value={newMobile}
                                    inputMode="numeric" pattern="[0-9]{10}" maxLength={10}
                                    onChange={e => { setNewMobile(e.target.value.replace(/\D/g, "").slice(0, 10)); setContactError(""); }}
                    ...
                    <div className="space-y-2">
                        ...
                        {editing && (
                            <div className="flex gap-2">
                                <input type="email" placeholder="Add different email" value={newEmail}
                                    onChange={e => { setNewEmail(e.target.value.trim().toLowerCase()); setContactError(""); }}
                                    className="flex-1 bg-white/6 border border-white/15 rounded-xl px-3 py-2 text-sm text-white placeholder-white/20 focus:outline-none focus:border-amber-400/60" />
