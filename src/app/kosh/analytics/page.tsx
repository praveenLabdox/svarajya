...
import { ArrowLeft, ChevronRight, Info, Shield, TrendingUp, Eye, CheckCircle2 } from "lucide-react";
...
export default function AnalyticsPage() {
    ...
    const pillars = [
        ...
        },
        {
            ...
            details: [
                `Recently reviewed: ${records.filter(r => r.lastReviewedAt && (Date.now() - r.lastReviewedAt) < 90 * 24 * 60 * 60 * 1000).length}/${records.length}`,
